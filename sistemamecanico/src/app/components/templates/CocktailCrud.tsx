...
export function CocktailCrud() {
  ...
  const [selectedCocktail, setSelectedCocktail] = useState<Car | null>(null);
  const [deletingCocktail, setDeletingCocktail] = useState<Car | null>(null);
  ...
  function openEdit(cocktail: Car) {
